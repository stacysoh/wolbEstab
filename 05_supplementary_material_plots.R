...
########################################################################
#intervention start date at = 1700
#intervention end date at 2400
...
png(file="C:/Users/stacy/OneDrive/Desktop/Work/wolb/fig_s1.png",units='in',height=16,width=15,res=150)
...
png(file="C:/Users/stacy/OneDrive/Desktop/Work/wolb/fig_s2.png",units='in',height=24,width=22,res=150)
...
png(file="C:/Users/stacy/OneDrive/Desktop/Work/wolb/fig_s3.png",units='in',height=24,width=22,res=150)
#par(las=1,mfrow=c(3,3),mar = c(3.5, 7.3, 2, 0.8),pty='s') #bottom left top right
par(las=1,mfrow=c(3,3),mar = c(7.8, 7.3, 3.8, 0.8),pty='s') #bottom left top right

plot(x=c(0,3500),y=range(femaleMosW1_overfloodingwerror), #range(femaleMosU_supp) c(0,2200)
     col="white", las=1, xlab="", ylab="", 
     yaxt="n", xaxt="n", 
     main = "", adj = 0, cex.main=2)
axis(2, at=c(0, 1000, 2000, 3000, 4000), labels=c(0,1,2,3,4), cex.axis=3.6)
...
png(file="C:/Users/stacy/OneDrive/Desktop/Work/wolb/fig_s4.png",units='in',height=8,width=22,res=150)
#par(las=1,mfrow=c(3,3),mar = c(3.5, 7.3, 2, 0.8),pty='s') #bottom left top right
